...
for start in G.nodes():
    ...
    for end in G.nodes():
        ...
        try:
            # weight: edge attribute to minimize when solving shortest path. default is edge length in meters.
            # uses 'dijkstra'
...
print(
    f"The new dimensions of the time_matrix are: {len(cleaned_time_matrix)}x{len(cleaned_time_matrix)}")
